    ...
    <div className="">
      <div className="container">
        <div className="mt-16">
          ...
          <div className="flex flex-col md:flex-row my-10 gap-6 md:gap-8 lg:gap-10 align-top justify-between">
            <div className="w-full md:w-1/3 p-6 text-white bg-[#e8a900]">
              <h3 className="text-5xl md:text-4xl lg:text-5xl font-semibold">
                Katta rahmat!
              </h3>
              <p className="text-xl md:text-lg lg:text-xl mt-4">
                Uy sotib olganimizdan judayam xursandmiz. Narxlar arzon va uylar
                sifatli.
              </p>
              <div className="w-full mt-8 flex justify-end">
                <p className="text-2xl md:text-xl lg:text-2xl">— G'oybu, Alisher</p>
              </div>
            </div>
            <div className="w-full md:w-1/3 p-6 text-white bg-[#e8a900]">
              <h3 className="text-5xl md:text-4xl lg:text-5xl font-semibold">
              ...
              <div className="w-full mt-8 flex justify-end">
                <p className="text-xl md:text-xl lg:text-2xl">— Urganch, Sarvar</p>
              </div>
            </div>
            <div className="w-full md:w-1/3 p-6 text-white bg-[#e8a900]">
              <h3 className="text-5xl md:text-4xl lg:text-5xl font-semibold">
              ...
              <div className="w-full mt-8 flex justify-end">
                <p className="text-2xl md:text-xl lg:text-2xl">— Urganch, Severa</p>
              </div>
            </div>
          </div>
        </div>
